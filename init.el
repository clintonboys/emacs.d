...
(set-face-attribute 'default nil :font "IBM Plex Mono" :height clinton/default-font-size)

;; Set the fixed pitch face
(set-face-attribute 'fixed-pitch nil :font "Fira Code" :height clinton/default-font-size)

;; Set the variable pitch face
(set-face-attribute 'variable-pitch nil :font "Cantarell" :height clinton/default-variable-font-size :weight 'regular)
